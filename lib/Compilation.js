...
Compilation.prototype.finish = function finish() {
	...
	this.modules.forEach(function(m) {
		this.reportDependencyErrorsAndWarnings(m, [m]);
	}, this);
};
...
Compilation.prototype.reportDependencyErrorsAndWarnings = function reportDependencyErrorsAndWarnings(module, blocks) {
	var _this = this;
		...
		block.dependencies.forEach(function(d) {
			...
			if(errors) {
				errors.forEach(function(w) {
					var warning = new ModuleDependencyError(module, w, d.loc);
					_this.errors.push(warning);
				});
			}
		});
		_this.reportDependencyErrorsAndWarnings(module, block.blocks);
	});
};
